        ...
        <div class="w3-third">
          <div class="w3-white w3-text-grey w3-card-4">
            <div class="w3-display-container">
              <img src="../assets/pic.jpg" style="width:100%" alt="Avatar">
              <div class="w3-display-bottomleft w3-container w3-text-black">
                <h2>Tanawat Wirattangsakul</h2>
              </div>
            </div>
            <div class="w3-container">
              ...
              <p>
                <i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>Phuket, Thailand
              </p>
              <p>
                <i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>webmaster.tanawat@gmail.com
              </p>
              <p>
                <i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>0658678035
              </p>
              <hr>
        ...
        <div class="w3-twothird">
          <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <div class="w3-container">
              ...
              <h6 class="w3-text-teal">
                <i class="fa fa-calendar fa-fw w3-margin-right"></i>Mar 2012 - Dec 2014
              </h6>
            ...
            <div class="w3-container">
              ...
              <h6 class="w3-text-teal">
                <i class="fa fa-calendar fa-fw w3-margin-right"></i>Jun 2010 - Mar 2012
              </h6>
          ...
          <div class="w3-container w3-card w3-white">
            ...
            <div class="w3-container">
              <h5 class="w3-opacity">
                <b>Prince of Songkhla University Phuket Campus</b>
              </h5>
              <h6 class="w3-text-teal">
            ...
            <div class="w3-container">
              <h5 class="w3-opacity">
                <b>Kanarassadonbumrung School</b>
              </h5>
              <h6 class="w3-text-teal">
                <i class="fa fa-calendar fa-fw w3-margin-right"></i>2010 - 2012
              </h6>
              <p>Sci Math</p>
              <hr>
            </div>
            <div class="w3-container">
              <h5 class="w3-opacity">
                <b>Satree Yala School</b>
              </h5>
              <h6 class="w3-text-teal">
                <i class="fa fa-calendar fa-fw w3-margin-right"></i>2008 - 2010
              </h6>
              <p>English Program</p>
              <br>
            </div>
