  ...
  <div class="login-card">
    ...
    <div class="content">
      <form method="POST" action="#">
        ...
        <input id="rePassword" type="password" name="rePassword" title="repassword" placeholder="Re-Password" required>
...
#login .login-card #email, #login .login-card #password, #login .login-card #rePassword{
  display: block;
  width: 100%;
  font-size: 1rem;
...
#login .login-card #email:hover, #login .login-card #password:hover, #login .login-card #rePassword:hover {
  border-color: #7a7a7a;
}
...
#login .login-card #rePassword:active, #login .login-card #rePassword:focus {
  border-color: #00d1b2;
}
